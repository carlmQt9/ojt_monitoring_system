...
1.	 Open your web browser and navigate ojtms-prmsuscz.com. You will land on the Landing Page.
...
2.	Use the search bar to find a specific intern by name or email. The search checks all intern cards, including cards on other pagination pages.
3.	Click an intern card to expand it — four tabs appear.

Review and Approve All Pending Time-Outs
1.	Click Review Time-Outs beside the Intern search bar.
2.	Review the compact list of pending completed time-out records.
3.	Click View Logs on a record to open that intern's time records. The Supervisor dashboard opens the intern's Time Edits tab directly.
4.	Return to the review dialog and click Approve All after checking the records.
5.	The system approves eligible records, credits regular hours, handles approved overtime, updates daily logs, and notifies affected students.

Note: Supervisors can approve only records for interns assigned to them or registered under their company. Records without a completed time-out are not included.
...
3.	Type a student name in the Search bar to find them quickly. The search checks all students, including students on other pagination pages.
  If a matching student is on another page, the list moves to the page containing the result.
...
Review and Approve All Pending Time-Outs
1.	Click Review Time-Outs beside the Student search bar.
2.	Review all pending completed time-out records for students under the Coordinator's system-wide scope.
3.	Click View Logs on a record to inspect that student's recent time logs.
4.	Click Approve All in the review dialog to confirm the bulk approval.
5.	The system approves eligible records, credits hours, updates daily logs, handles overtime status, and sends student notifications.

Note: Only records with both a time-in and time-out are included. The review dialog must be checked before final confirmation.
...
2.	Search is immediate and checks all loaded IDs, including IDs on other pagination pages.
3.	The usage indicator beside the search bar shows used IDs out of the total for the current school-year list, for example Used: 75 / 100.
...
6.10 Loading and Search Behavior
