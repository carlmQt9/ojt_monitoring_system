    ...
    <div id="pageLoader" class="hidden fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-6"
        ...
        <div class="relative">
            <svg class="animate-spin" style="width:64px;height:64px;" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" stroke="rgba(59,130,246,0.2)" stroke-width="3"/>
                <path d="M4 12a8 8 0 018-8" stroke="#3b82f6" stroke-width="3" stroke-linecap="round"/>
            </svg>
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-8 h-8 bg-blue-500/30 rounded-full animate-pulse"></div>
            </div>
        </div>
        <p id="pageLoaderMsg" style="color:#93c5fd;font-size:16px;font-weight:600;font-family:sans-serif;letter-spacing:.05em;">Signing in, please wait…</p>
    </div>
</body>
</html>
