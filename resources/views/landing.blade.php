...
<body class="text-white">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            ...
            <div class="space-y-6">
                ...
                <p class="text-blue-200 text-lg leading-relaxed max-w-md fade-up delay-2">
                    A complete On-the-Job Training monitoring platform for students, supervisors, coordinators, and CCIT Head — all in one place.
                </p>
                ...
                <div class="grid grid-cols-2 sm:flex sm:gap-8 gap-4 pt-4 fade-up delay-3">
                    ...
                    <div class="sm:border-l sm:border-blue-800 sm:pl-8">
                        ...
                        <div class="text-xs text-blue-400">OJT Hours</div>
                    </div>
                    <div class="sm:border-l sm:border-blue-800 sm:pl-8">
                        <div class="text-2xl font-bold text-white">DTR</div>
                        <div class="text-xs text-blue-400">Auto Reports</div>
                    </div>
                    <div class="sm:border-l sm:border-blue-800 sm:pl-8">
                        <div class="text-2xl font-bold text-white">Live</div>
                        <div class="text-xs text-blue-400">Monitoring</div>
                    </div>
                </div>
            </div>
    ...
    <section id="about" class="py-20 border-t border-blue-900/40" style="background:linear-gradient(180deg,#0a1a5c,#050d2e)">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-3xl font-bold text-white mb-4">Built for PRMSU Sta.Cruz<br>BSCS OJT Program</h2>
                <p class="text-blue-200 leading-relaxed mb-6">
                    This system was designed to digitize and streamline the entire OJT process — from student time-in/out tracking and daily task logging to supervisor evaluations and coordinator oversight.
                </p>
                <ul class="space-y-3 text-blue-200 text-sm">
                    <li class="flex items-center gap-3"><span class="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center text-green-400 text-xs">✓</span> <span><span class="text-green-400 font-semibold">Students</span> — time-in/out with camera photo, attendance history, requirements upload, reports</span></li>
                    <li class="flex items-center gap-3"><span class="w-6 h-6 bg-purple-500/20 rounded-full flex items-center justify-center text-purple-400 text-xs">✓</span> <span><span class="text-purple-400 font-semibold">Supervisors</span> — view intern progress, approve/reject requirements, task logs</span></li>
                    <li class="flex items-center gap-3"><span class="w-6 h-6 bg-orange-500/20 rounded-full flex items-center justify-center text-orange-400 text-xs">✓</span> <span><span class="text-orange-400 font-semibold">Coordinators</span> — monitor all students, view DTR records, manage companies</span></li>
                    <li class="flex items-center gap-3"><span class="w-6 h-6 bg-red-500/20 rounded-full flex items-center justify-center text-red-400 text-xs">✓</span> <span><span class="text-red-400 font-semibold">CCIT Head</span> — full analytics, user management, school year & settings</span></li>
                </ul>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-green-900/20 border border-green-700/40 rounded-xl p-5 hover:border-green-500 transition-colors">
                    ...
                    <div class="text-xs text-green-300/70">Time-in/out · Requirements · Reports · DTR</div>
                </div>
                <div class="bg-purple-900/20 border border-purple-700/40 rounded-xl p-5 hover:border-purple-500 transition-colors">
                    ...
                    <div class="text-xs text-purple-300/70">Intern progress · Approve requirements</div>
                </div>
                <div class="bg-orange-900/20 border border-orange-700/40 rounded-xl p-5 hover:border-orange-500 transition-colors">
                    ...
                    <div class="text-xs text-orange-300/70">All students · DTR · Companies</div>
                </div>
                <div class="bg-red-900/20 border border-red-700/40 rounded-xl p-5 hover:border-red-500 transition-colors">
                    ...
                    <div class="text-xs text-red-300/70">Analytics · Users · School years · Settings</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features" class="py-20 border-t border-blue-900/40" style="background:#050d2e">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @php
                $features = [
                    ['icon'=>'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z','title'=>'Camera Time-In / Out','desc'=>'Students clock in and out using their device camera. Photos are captured and stored for verification.','color'=>'cyan'],
                    ['icon'=>'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z','title'=>'Progress Tracking','desc'=>'Real-time OJT hours tracking with visual progress bars, charts, and 600-hour completion monitoring.','color'=>'blue'],
                    ['icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','title'=>'Requirements & Reports','desc'=>'Upload onboarding documents and daily reports (PDF, Word, Excel, images) up to 5 MB each.','color'=>'green'],
                    ['icon'=>'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10','title'=>'Analytics Dashboard','desc'=>'Charts for student progress, report status, daily time-ins, and top companies — per role.','color'=>'purple'],
                    ['icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','title'=>'DTR Generation','desc'=>'Auto-generate Daily Time Records viewable inline or exported as Word documents per student.','color'=>'yellow'],
                    ['icon'=>'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z','title'=>'School Year & User Management','desc'=>'CCIT Head manages school years, required hours, companies, and all user accounts in one place.','color'=>'red'],
                ];
    ...
    <section class="py-20 border-t border-blue-900/40 relative overflow-hidden" style="background:linear-gradient(135deg,#0a1a5c,#0d2d8a)">
        ...
        <div class="relative max-w-3xl mx-auto px-6 text-center">
            ...
            <p class="text-blue-200 mb-8">Register now and start tracking your OJT journey with the PRMSU Sta. Cruz official OJT Monitoring System. Secure accounts with strong password requirements and reCAPTCHA protection.</p>
    ...
    <!-- FOOTER -->
    <footer id="contact" class="border-t border-blue-900/40 py-10" style="background:#030a1e">
